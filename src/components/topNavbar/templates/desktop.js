...
<ul className="navbar-top-desktop right hide-on-med-and-down">
  <li id="li-${NavItems.id.home}"><a className="waves-effect waves-custom" href=${NavItems.links.home} >${NavItems.items.home}</a></li>
  <li id="li-${NavItems.id.id1}"><a className="waves-effect waves-custom" href=${NavItems.links.link1} >${NavItems.items.item1}</a></li>
  <li id="li-${NavItems.id.id2}"><a className="waves-effect waves-custom" href=${NavItems.links.link2}>${NavItems.items.item2}</a></li>
  <li id="li-${NavItems.id.id3}"><a className="waves-effect waves-custom" href=${NavItems.links.link3}>${NavItems.items.item3}</a></li>
</ul>
`
